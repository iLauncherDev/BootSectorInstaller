...
#define VBR_FILESYSTEM_EXT_SIZE (SECTOR_SIZE * 3)
...
static_assert(sizeof(EXT_VBR) <= VBR_FILESYSTEM_EXT_SIZE, "The EXT VBR structure must be less or equal than 1536 bytes");
